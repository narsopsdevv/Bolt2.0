...
export default {
  ...
  SIGNIN_HEADING: 'Continue With LaunchBase',
  SIGNIN_SUBHEADING: 'To use LaunchBase you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using LaunchBase, you agree to the collection of usage data for analytics.',
